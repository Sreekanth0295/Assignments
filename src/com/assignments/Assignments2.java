...
public class Assignments2 {
	...
	public static void main(String[] args) {
     ...
     System.out.println("Semester 3, Subject 4: " + data[2][3][0]); // Operating Systems
     System.out.println("Semester 3, Subject 5: " + data[2][4][0]); // Signals and Systems

     // Print marks of Semester 6, Subject 3 and Subject 6
     System.out.println("Semester 5, Subject 3 Marks: " + data[4][2][1]); // Compiler Design - 84
     System.out.println("Semester 5, Subject 6 Marks: " + data[4][5][1]); // Computer Graphics - 90
